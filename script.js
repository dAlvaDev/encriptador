const boton_encriptar = document.querySelector("#encryptor");
const boton_desencriptar = document.querySelector("#decrypter");

const input = document.querySelector("textarea");
const resultado = document.querySelector("#result");
const imagen = document.querySelector("#image");
const textdefault1 = document.querySelector("#text-default-1");
const textdefault2 = document.querySelector("#text-default-2");
